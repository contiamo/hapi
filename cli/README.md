...
Run Claude Code sessions from your terminal and control them remotely through the hapi server.
...
- `hapi mcp` - Start MCP stdio bridge. See `src/claude/happyMcpStdioBridge.ts`.
